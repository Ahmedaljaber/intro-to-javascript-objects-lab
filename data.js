...
/*
console.dir() and console.log() show only the first 100 items in an array.
However, by using { maxArrayLength: null } with console.dir(),
we can display every item in the array.
This specific option isn’t available with console.log(), making console.dir()
*/
...
Exercise 3
  ...
  */
  ...
  game.party.push(starterPokemon[0]);
  ...
  */
  ...
  const morePokemon = pokemon.filter((pokemon) => pokemon.starter === false);
  game.party.push(morePokemon[0], morePokemon[1], morePokemon[2]);
  ...
  */
  ...
  const evolvedPokemon = pokemon.find((pokemon) => {
    if (game.party[starterPokemonIndex].name === "Bulbasaur")
      return pokemon.name === "Ivysaur";
    if (game.party[starterPokemonIndex].name === "Charmander")
      return pokemon.name === "Charmeleon";
    if (game.party[starterPokemonIndex].name === "Squirtle")
      return pokemon.name === "Wartortle";
    if (game.party[starterPokemonIndex].name === "Pikachu")
      return pokemon.name === "Raichu";
  });
  ...
  */
  ...
  console.log(game.party.map((pokemon) => pokemon.name));
  ...
  */
  const allStarterPokemon = pokemon.filter((pokemon) => pokemon.starter);
  ...
  */
  ...
  // Copy and modify the catchPokemon method
  game.catchPokemon = function (pokemonObj) {
    game.party.push(pokemonObj);
  ...
  // Call the catchPokemon method and pass in a Pokemon object
  game.catchPokemon(pokemon[1]);
  
  // Log the game.items array to confirm the pokeball quantity is being decremented
  ...
  */
  ...
  // Update the complete property of gyms with a difficulty below 6
  game.gyms.forEach((gym) => {
    if (gym.difficulty < 6) {
      gym.complete = true;
    }
  ...
  */
  ...
  game.gymStatus = function () {
    ...
    // gyms array and update the tally
    game.gyms.forEach((gym) => {
      if (gym.complete) {
        gymTally.completed++;
      } else {
  ...
  */
  // Add a partyCount method to game
...
// Exersise 2 and end of the exersises 
